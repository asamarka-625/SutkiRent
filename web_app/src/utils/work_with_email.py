    ...
    async def send_verification_email(self, email: str, code: str) -> bool:
        ...
        <body>
            <div class="container">
                ...
                <p>Вы зарегистрировались в системе уведомлений ФМС. 
                ...
                <div class="footer">
                    <p>С уважением,<br>Команда системы уведомлений ФМС</p>
        ...
        Вы зарегистрировались в системе уведомлений ФМС.
        ...
        С уважением,
        Команда системы уведомлений ФМС
        """
    ...
    async def send_password_reset_email(self, email: str, reset_token: str, name: str) -> bool:
        ...
        <body>
            <div class="container">
                ...
                <p>Мы получили запрос на восстановление пароля для вашей учетной записи в системе уведомлений ФМС.</p>
        ...
        Мы получили запрос на восстановление пароля для вашей учетной записи в системе уведомлений ФМС.
        ...
        # Создаем сообщение
        message = MIMEMultipart("alternative")
        message["Subject"] = "Восстановление пароля в системе ФМС"
        message["From"] = self.from_email
        message["To"] = email
